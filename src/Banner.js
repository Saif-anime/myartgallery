...
function Banner() {
    ...
    const fetchData = async (id) => {
        if (id) {
            ...
            try {
                const response = await fetch(`${process.env.REACT_APP_API_FETCH_URL}/Admin/Banner`);
                if (response.ok) {
        ...
        <>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div class="modal-body">
                                ...
                                <div class="input-group mb-3">
                                    ...
                                    <input type="text" class="form-control" id="basic-url" aria-describedby="basic-addon3" value={bannerLink}
            ...
            <div class="modal fade" id="ExtralargeModal2" tabindex="-1">
                <div class="modal-dialog ">
                    ...
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Banner Update</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                            ...
                            <div class="input-group mb-3">
                                <span class="input-group-text" id="basic-addon3">https://example.com/users/</span>
                                <input type="text" class="form-control" id="basic-url" name="vanityUrl"
                                    value={bannerData.vanityUrl}
                                    onChange={UpdatehandleInputChange} aria-describedby="basic-addon3" />
                            </div>

                            <div class="row mb-3">
                                <label for="inputNumber" class="col-sm-12 col-form-label">File Upload</label>
                                <div class="col-sm-12">
                                    <input class="form-control" type="file" id="formFile" onChange={UpdatehandleFileChange} />
                                </div>
                            </div>
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
                            <button type="button" class="btn btn-primary" onClick={() => UpdatehandleSubmit(bannerData._id)}>Save changes</button>
                        </div>
                    </div>
