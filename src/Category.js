                                            ...
                                            <table class="table table-borderless">
                                                ...
                                                <tbody>
...

                                                    {
                                                        data.map((v) => {
                                                            return <tr key={v._id}>
                                                                <th scope="row"><Link href={v.CategoryImg} rel="noopener noreferrer" target='_blank'><img src={v.CategoryImg} alt="" /></Link></th>
                                                                <td><Link href="#" class="text-primary fw-bold">{v.title}</Link></td>
