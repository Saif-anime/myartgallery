...
function Offer() {
    ...
    const fetchData = async (id) => {
        if (id) {
            try {
                const resp = await fetch(`${process.env.REACT_APP_API_FETCH_URL}/Admin/Offer/${id}`);
                if (resp.ok) {
            ...
            try {
                const response = await fetch(`${process.env.REACT_APP_API_FETCH_URL}/Admin/Offer`);
                if (response.ok) {
    ...
    const BannerShowFun = async (id, isActive) => {
        ...
        if (isActive === 1) {
            try {
                const response = await fetch(`${process.env.REACT_APP_API_FETCH_URL}/Admin/Offer/${id}`, {
                    method: 'DELETE',
                    body: isActive,
                });
        ...
        <>
                ...
                <div class="modal-dialog ">
                    ...
                    <form onSubmit={handleSubmit}>
                        ...
                        <div class="modal-body">
                            ...
                            <div class="row mb-3">
                                <label for="inputText" class="col-sm-12 col-form-label">Offer Name</label>
                                <div class="col-sm-12">
            ...
            <div class="modal fade" id="ExtralargeModal2" tabindex="-1">
                <div class="modal-dialog ">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title">Offer Update</h5>
                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
